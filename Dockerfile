...
COPY ${EFFECTIVE_VERSIONS_FILE} /usr/local/share/pi-cli/docker-constructor.toml
RUN chown root:root /usr/local/share/pi-cli/docker-constructor.toml \
    && chmod 0444 /usr/local/share/pi-cli/docker-constructor.toml
