...
Define the Node.js base image contract for the Pi Docker runtime, ensuring a reproducible, Debian-codenamed slim image pinned to an explicit Debian release.
